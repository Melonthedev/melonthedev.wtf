...
if(browsersprache.indexOf(sitelang) > -1) {
    ...
    if(browsersprache.indexOf("de") > -1) {
        ...
        document.getElementById("langinfo").classList.remove("invisibility");
        document.getElementById("langbutton").classList.remove("invisibility");
        document.getElementById("langbutton2").classList.remove("invisibility");
